  ...
  jQuery("#addRow").on('click',function ()
  {
          $("#totalHolder").append(`
              <div class="row data-row">
                  <div id='id' hidden class="col border  text-center">0</div>
                  <div id='datas' hidden class="col border  text-center">1</div>
                  <div id='events'  class="col border  text-center"></div>
                  <div id='person' class="col border  text-center"></div>
                  <div id='thing' class="col border text-center"></div>
                  <div id='locat' class="col border  text-center"></div>
              </div>
              <div class="row data-row">
                  <div hidden class="col border p-2 text-center"><a id='id-button' href=''><button class="btn btn-primary">Изменить</button></a></div>
